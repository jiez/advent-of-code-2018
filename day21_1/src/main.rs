...
fn setr(regs: &mut Vec<usize>, op0: usize, _op1: usize, op2: usize) {
    regs[op2 as usize] = regs[op0 as usize];
}

fn seti(regs: &mut Vec<usize>, op0: usize, _op1: usize, op2: usize) {
...
fn main() {
    ...
    let mut file = File::open("/home/jie/projects/rust/advent/day21_1/input")
...
//        println!("ip = {}", ip);
        ...
        if ip == 28 {
            if prev_r4 == 0 {
                println!("least instructions R4 = {}", regs[4]);
            }
            //println!("R4 = {}", regs[4]);
            if ! r4_set.insert(regs[4]) {
                println!("most instructions R4 = {}", prev_r4);
                break;
            }
            prev_r4 = regs[4];
        }
